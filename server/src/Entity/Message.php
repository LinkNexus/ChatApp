...
class Message
{
    ...
    #[ORM\JoinTable(name: 'message_to_receiver')]
    private Collection $toUsers;
     ...
     */
    public function getToUsers(): Collection
    {
        return $this->toUsers;
    }

    public function addToUser(User $toUser): static
    {
    ...
    public function removeToUser(User $toUser): static
    {
